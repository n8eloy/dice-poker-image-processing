...
bw_roll = binarizeImg(roll_img, 120); % segundo argumento é o limiar.
                                      % Se for 0, aplicará imbinarize com
                                      % graythresh, se for algum número
                                      % entre 1 e 254, realizará a
                                      % binarização considerando esse
                                      % limiar.
